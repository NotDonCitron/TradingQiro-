...
class VIPGroupDiagnoser:
    ...
    async def send_report_message(self, message: str) -> bool:
        ...
        try:
            ...
            print("❌ Report Send Error: {}".format(e))
            return False
    ...
    async def test_session_status(self) -> bool:
        ...
        try:
            ...
            print("   Name: {} {}".format(me.first_name, me.last_name or ''))
            print("   Username: @{}".format(me.username or 'kein_username'))
            print("   ID: {}".format(me.id))
            print("   Telefon: {}".format(me.phone or 'nicht verfügbar'))
            print("   Bot: {}".format(getattr(me, 'bot', False)))
            
            return True
            
        except Exception as e:
            self.diagnosis_results["error_details"].append("Session Error: {}".format(e))
            print("❌ Session Fehler: {}".format(e))
            return False
